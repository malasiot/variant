...
#ifdef VARIANT_NAMESPACE
    #define VARIANT_NAMESPACE_BEGIN namespace VARIANT_NAMESPACE {
    #define VARIANT_NAMESPACE_END   }
#else
    #define VARIANT_NAMESPACE_BEGIN 
    #define VARIANT_NAMESPACE_END   
#endif
